...
echo "</a>";
echo "</li>";
echo "<li class='sidebar-item " . is_active_page(['resource_management.php']) . "'>";
echo "<a href='{$CFG->wwwroot}/theme/remui_kids/admin/resource_management.php' class='sidebar-link'>";
echo "<i class='fa fa-sliders-h sidebar-icon'></i>";
echo "<span class='sidebar-text'>Resource Management</span>";
echo "</a>";
echo "</li>";
echo "<li class='sidebar-item " . is_active_page(['ebook_management.php']) . "'>";
echo "<a href='{$CFG->wwwroot}/theme/remui_kids/admin/ebook_management.php' class='sidebar-link'>";
echo "<i class='fa fa-book-reader sidebar-icon'></i>";
echo "<span class='sidebar-text'>E-Book Management</span>";
echo "</a>";
echo "</li>";
echo "</ul>";
echo "</div>";
