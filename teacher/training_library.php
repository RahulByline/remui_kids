        ...
        <div class="col-12">
            ...
            <div class="main-content">
                <div class="teacher-page-header">
                    ...
                    <p class="page-subtitle">How-to videos and training guides to help you use the Social Science LMS effectively.</p>
                </div>
                ...
                <div class="teacher-page-panel training-library-panel">
                    ...
                    <div class="training-library-search">
                        <div class="help-search-container">
                            <i class="fa fa-search" style="position:absolute;left:14px;color:#6b7280;z-index:1;"></i>
                            <input type="text" id="trainingSearchInput" class="help-search-input" placeholder="Search training videos by title, description, or category..." />
                            <button type="button" id="trainingSearchClear" style="display:none;position:absolute;right:12px;background:transparent;border:none;color:#999;cursor:pointer;z-index:1;">
                                <i class="fa fa-times"></i>
                            </button>
                        </div>
                        <div id="trainingSearchCount" style="display:none;margin-top:10px;color:#6b7280;font-size:14px;"></div>
                    </div>
                                    ...
                                    <?php foreach ($data['videos'] as $video): ?>
                                        ...
                                        >
                                            ...
                                            <div class="video-meta">
                                                <span><i class="fa fa-eye"></i> <?php echo (int) ($video->views ?? 0); ?> views</span>
                                                <?php if (!empty($video->durationformatted)): ?>
                                                    <span><i class="fa fa-clock-o"></i> <?php echo s($video->durationformatted); ?></span>
                                                <?php endif; ?>
